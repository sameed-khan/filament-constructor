    function lenStats = generateLengthStats(treeArray, outputPath)
if nargin < 2
    outputPath = false;
end
...
if outputPath
    writetable(output, sprintf('D:/Documents/Arora Lab Stuff/RAW_DATA/%s/%s/Output Statistics/Length_Stats_%i.csv', res,sample,i));
end
end